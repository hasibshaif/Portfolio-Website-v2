...
function BentoCard({
  ...
  return (
    <div className={cn("relative rounded-md overflow-hidden", className)}>
      ...
      {/* Content */}
      <section className="relative z-10 flex h-full flex-col gap-2 p-4">
        <header>
          <div className="mb-2 flex items-center gap-2">
            {icon}
            <p className="text-md line-clamp-1 font-bold text-white">{title}</p>
          </div>
        </header>
...
function GetGradient() {
  return (
    <BentoCard
      ...
      gradient="linear-gradient(to bottom right, cyan-900, sky-600, indigo-600)"
    >
...
function LinearGradient() {
  return (
    <BentoCard
      ...
      gradient="linear-gradient(to bottom right from-red-300 via-60% via-rose-300 to-red-200)"
...
function RadialGradient() {
  return (
    <BentoCard
      ...
      gradient="linear-gradient(to bottom right, from-lime-300 via-60% via-green-200 to-lime-200)"
      className="group sm:col-span-1"
    >
...
function ConicGradient() {
  return (
    <BentoCard
      ...
      gradient="linear-gradient(to bottom right, from-cyan-900 via-60% via-sky-600 to-indigo-600)"
