...
export default function ExternalLinkButton({ text = "Open Link" }: ButtonTitleProps) {
  return (
    <button className="text-md group flex items-center justify-center gap-1 rounded-md bg-black/10 px-6 py-3 text-white hover:cursor-pointer hover:text-yellow-300">
      <span>{text}</span>
      <ArrowUpRight
        height={20}
        width={20}
